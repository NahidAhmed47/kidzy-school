    ...
    return (
        <div className='grid md:grid-cols-2 w-full'>
            <div className='px-5 flex flex-col justify-center'>
                ...
                <div className='w-1/3 flex fle'>
                    <Link to='/class'>
                        <button className='btn'>Start Class</button>
                    </Link>
                    <Link to='/class'>
                        <button className='p-2 bg-orange-300 rounded-full'><PlayIcon className='w-6 h-6 primary-text-color'></PlayIcon></button>
                    </Link>
                </div>
            </div>
            <div>
                <Lottie animationData={onlineEducationAni} loop={true}></Lottie>
            </div>
        </div>
    );
};
